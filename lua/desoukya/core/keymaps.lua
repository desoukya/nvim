...
keymap.set("n", "<leader>ft", ":Telescope telescope-tabs list_tab<cr>") -- use telescope-tabs to see all open tabs
...
keymap.set("n", "<leader>gs", ":LazyGit<cr>") -- use lazy git to show delta and create commits
keymap.set("n", "<leader>gb", ":GitBlameToggle<cr>") -- git blame for each line
